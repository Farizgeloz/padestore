...
class Controller_Pesanan_Selesai extends Controller
{
    ...
    public function index(): View
    {
        ...
        $pesananku = Tpesanan::leftJoin('tpelanggans', 'tpesanans.pelanggan', '=', 'tpelanggans.id_pelanggan')
            ...
            ->whereIn('tpesanans.status', ['Selesai']) // ✅ benar
            ->orderBy('tpesanans.tanggal', 'DESC')
            ->orderBy('tpesanans.status', 'ASC')   // 🔹 urutan pertama
            ->paginate(10);
       
       
        return view('folder_pesanan_selesai.page_pesanan_selesai', 
            ...
            $pesananku = Tpesanan::leftJoin('tpelanggans', 'tpesanans.pelanggan', '=', 'tpelanggans.id_pelanggan')
                ...
                ->where(function ($query) use ($request) {
                    $query->where('tpesanans.jenis', 'like', '%' . $request->search . '%')
                        ...
                        ->orWhere('tproduks.nama_produk', 'like', '%' . $request->search . '%');// cari juga di nama produk
                })
                ->orderBy('tpesanans.tanggal', 'DESC')
                ->orderBy('tpesanans.status', 'ASC')   // 🔹 urutan pertama
                ->paginate(10);
    ...
    public function create(): View
    {
        ...
        return view('folder_pesanan_selesai.create', compact(
    ...
    public function storeku(Request $request): RedirectResponse
    {
        ...
        /* return redirect()->route('folder_pesanan_selesai.page_pesanan_selesai')
            ->with('success', $pesan); */
        return redirect()->route('folder_pesanan_selesai.page_pesanan_selesai')
    ...
    public function show(string $id): View
    {
        ...
        // render view
        return view('folder_pesanan_selesai.show', compact('pesananku'));
    }
    ...
    public function edit(string $id): View
    {
        ...
        return view('folder_pesanan_selesai.edit', 
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        return redirect()->route('folder_pesanan_selesai.page_pesanan_selesai')->with(['success' => 'Data Berhasil Diubah']);
    }
    ...
    public function destroy($id): RedirectResponse
    {
        ...
        return redirect()->route('folder_pesanan_selesai.page_pesanan_selesai')->with(['success' => 'Data Berhasil Dihapus']);
    }
}
