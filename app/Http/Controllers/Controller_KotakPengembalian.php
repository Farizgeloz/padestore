...
class Controller_KotakPengembalian extends Controller
{
    // 
    ...
    public function index(): View
    {
        ...
        $pesananku = Tpesanan::leftJoin('tpelanggans', 'tpesanans.pelanggan', '=', 'tpelanggans.id_pelanggan')
            ...
            ->whereIn('tpesanans.status', ['Dropsit', 'PickedUp']) // ✅ benar
            ->orderBy('tpesanans.updated_at', 'DESC')
            ->orderBy('tpesanans.status', 'ASC')   // 🔹 urutan pertama
            ->paginate(10);
       
       
        return view('folder_kotakpengembalian.page_kotakpengembalian', 
    ...
    public function search(Request $request)
    {
        ...
        $akunuserlogin = Auth::user()->akun;  
            ...
            $pesananku = Tpesanan::join('tpelanggans', 'tpesanans.pelanggan', '=', 'tpelanggans.id_pelanggan')
                ...
                ->select('tpesanans.*', 'tpelanggans.nama_pelanggan') // ambil kolom pelanggan juga
                ->orderBy('tpesanans.updated_at', 'DESC')
                ->paginate(10);
    ...
    public function create(): View
    {
        ...
        return view('folder_kotakpengembalian.create', compact(
    ...
    public function storeku(Request $request): RedirectResponse
    {
        ...
        /* return redirect()->route('folder_kotakpengembalian.page_kotakpengembalian')
            ->with('success', $pesan); */
        return redirect()->route('folder_kotakpengembalian.page_kotakpengembalian')
    ...
    public function show(string $id): View
    {
        ...
        // render view
        return view('folder_kotakpengembalian.show', compact('pesananku'));
    }
    ...
    public function edit(string $id): View
    {
        ...
        return view('folder_kotakpengembalian.edit', 
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        return redirect()->route('folder_kotakpengembalian.page_kotakpengembalian')->with(['success' => 'Data Berhasil Diubah']);
    }
    ...
    public function destroy($id): RedirectResponse
    {
        ...
        return redirect()->route('folder_kotakpengembalian.page_kotakpengembalian')->with(['success' => 'Data Berhasil Dihapus']);
    }
}
