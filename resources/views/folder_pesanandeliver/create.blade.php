...
<div class="card mt-10 mb-5 bg-body-tertiary">
    ...
    <div class="card-body">
        ...
        @endif
        <form action="{{ route('folder_pesanandeliver.store') }}" method="post" enctype="multipart/form-data" class="row border  border-2 border-success bg-success-subtle rounded p-2">
            @csrf
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="form-group mb-2  col-md-12">
                        ...
                        <select class="form-select form-select-lg m-1 @error('jenis') is-invalid @enderror"  aria-label="Small select example"  name="jenis" id="">
                            <option  value="">Pilih Jenis</option>
                            <option value="Tahu Besar">Tahu Besar</option>
                            <option value="Tahu Kecil">Tahu Kecil</option>
                            <option value="Tahu Timur">Tahu Timur</option>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="form-group mb-2  col-md-12">
                        ...
                        <select class="form-select form-select-lg m-1 @error('pengantar') is-invalid @enderror" aria-label="Small select example"  name="pengantar" id="">
                    ...
                    <div class="form-group mb-2  col-md-12">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            @foreach($kotakku as $kotak)
                                <div class="form-check form-check-inline m-2 align-items-center  border  border-2 {{ $kotak->status === 'Keluar' ? 'border-danger' : 'border-success' }} rounded">
                                    <input 
                                        class="form-check-input me-1 {{ $kotak->status === 'Keluar' ? 'border-danger bg-danger' : 'border-success bg-success' }}"
                                        type="checkbox"
                                        name="kotak[]"
                                    ...
                                    <label 
                                        class="form-check-label  px-1 fw-semibold {{ $kotak->status === 'Keluar' ? 'text-danger' : 'text-dark' }}" 
