...
<div class="card mt-10 mb-5 bg-body-tertiary">
    <div class="card-header  bg-white">
        <h5>Form Tambah PickedUp Pesanan</h5>
    </div>
    <div class="card-body">
        ...
        @endif
        <form action="{{ route('folder_pesanan2.store') }}" method="post" enctype="multipart/form-data" class="row border  border-2 border-success rounded p-2">
            @csrf
