...
<div class="card mb-5 bg-body-tertiary">
    <div class="card-header  bg-white">
        <h4>Form Edit Pemasukan</h4>
    </div>
    <div class="card-body">
        @if ($roleuserlogin == "Super Admin" )
        <a href="/SuperAdmin/Pemasukan" class="btn btn-info btn-sm mb-3"><i class="fa fa-arrow-left"></i> Back</a>
        
        <form action="/SuperAdmin/Pemasukan/Update/{{$pemasukanku->id_pemasukan}}" method="POST"  enctype="multipart/form-data" class="row border  border-2 border-success rounded p-2"
            enctype="multipart/form-data">
    
        @elseif ($roleuserlogin == "Admin" )
        <a href="/Admin/Pemasukan" class="btn btn-info btn-sm mb-3"><i class="fa fa-arrow-left"></i> Back</a>
        
        <form action="/Admin/Pemasukan/Update/{{$pemasukanku->id_pemasukan}}" method="POST"  enctype="multipart/form-data" class="row border  border-2 border-success rounded p-2"
            enctype="multipart/form-data">
        @endif
            ...
            <div class="col-md-4">
                <div class="row">
                    <div class="form-group mb-2  col-md-12">
                        ...
                        <input type="text" class="form-control m-1 @error('nama_pemasukan') is-invalid @enderror"  placeholder="Nama Pemasukan"
                            name="nama_pemasukan" value="{{ old('nama_pemasukan', $pemasukanku->nama_pemasukan) }}" id="">
                    ...
                    <div class="form-group mb-2  col-md-12">
                        ...
                        <div class="position-relative m-1">
                            ...
                            <input 
                                ...
                                name="nominal" 
                                id="nominal"
                                value="{{ old('nominal', number_format($pemasukanku->nominal ?? 0, 0, ',', '.')) }}">
                        </div>
                        <!-- tampilkan pesan error -->
                        @error('nominal')
                            <div class="alert alert-danger mt-2">
                ...
                <div class="row">
                    <div class="form-group mb-2  col-md-12">
                        ...
                        <select class="form-select form-select-l m-1 @error('status') is-invalid @enderror" aria-label="Small select example"  name="validasi" id="">
                            <option  value="{{ old('validasi', $pemasukanku->validasi) }}">{{ old('validasi', $pemasukanku->validasi) }}</option>
                ...
                <div class="row">
                    <div class="form-group mb-2  col-md-12">
                        ...
                        <input type="date" class="form-control m-1 @error('tanggal') is-invalid @enderror"  placeholder="Tanggal"
                            name="tanggal" value="{{ old('tanggal', $pemasukanku->tanggal) }}" id="">
                        <!-- tampilkan pesan error -->
                        @error('tanggal')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
