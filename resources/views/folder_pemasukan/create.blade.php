...
<div class="card mt-10 mb-5 bg-body-tertiary">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('folder_pemasukan.store') }}" method="post" enctype="multipart/form-data" class="row border  border-2 border-success rounded p-2">
            @csrf
            <div class="col-md-6">
                <div class="row">
                    <div class="form-group mb-2  col-md-12">
                        ...
                        <input type="text" class="form-control m-1 @error('nama_pemasukan') is-invalid @enderror"  placeholder="Nama Pemasukan"
                            name="nama_pemasukan" value="{{ old('nama_pemasukan') }}" id="">
