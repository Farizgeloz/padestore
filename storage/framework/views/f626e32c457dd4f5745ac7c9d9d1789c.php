...
unset($__sessionArgs); ?>
        <?php if($roleuserlogin == "Super Admin" ): ?>
            <a href="/SuperAdmin/Deliver/Tambah" class="mb-3 btn btn-success btn-sm"> <i class="fa fa-plus"></i> Tambah Pesanan Pengiriman</a>
        
        <?php elseif($roleuserlogin == "Admin" ): ?>
            <a href="/Admin/Deliver/Tambah" class="mb-3 btn btn-success btn-sm"> <i class="fa fa-plus"></i> Tambah Pesanan Pengiriman</a>
        <?php endif; ?>

        <?php if($roleuserlogin == "Super Admin" ): ?>
        <form method="GET" action="/SuperAdmin/Deliver/Search" class="mb-2 row">
        <?php elseif($roleuserlogin == "Admin" ): ?>
        <form method="GET" action="/Admin/Deliver/Search" class="mb-2 row">
        <?php else: ?>
        <form method="GET" action="/Deliver/Search" class="mb-2 row">
        <?php endif; ?>
                    ...
                    <tr>
                        ...
                        <td class="text-center align-items-center">
                            <!-- dari middleware UserAkses-->
                                ...
                                <?php endif; ?>
                                <?php if($roleuserlogin == "Super Admin" ): ?>
                                <a href="/SuperAdmin/Deliver/Edit/<?php echo e($pesanan->id_pesanan); ?>"
                                ...
                                <?php elseif($roleuserlogin == "Admin" ): ?>
                                <a href="/Admin/Deliver/Edit/<?php echo e($pesanan->id_pesanan); ?>"
                                    class="btn btn-sm btn-warning"><i class="fa fa-pen"></i></a>
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalDelete<?php echo e($pesanan->id_pesanan); ?>">
                                    <i class="fa fa-trash"></i>
                                </button>
...
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\pabrik_tahu\resources\views/folder_pesanan_deliver/page_pesanan_deliver.blade.php ENDPATH**/ ?>