    ...
    <div class="wrapper max-height" style="margin-top:5px">
        <aside id="sidebar" class="hidden-gadget top-gadget expand px-2" style="height:100vh">
            ...
            <?php if($roleuserlogin == "Super Admin"): ?>
                ...
                <li class="sidebar-item">
                    <a href="/SuperAdmin/User" class="sidebar-link <?php echo e(request()->is('SuperAdmin/User') ? 'active' : ''); ?>">
                ...
                <li class="sidebar-item">
                    <a href="/SuperAdmin/Pelanggan" class="sidebar-link <?php echo e(request()->is('SuperAdmin/Pelanggan') ? 'active' : ''); ?>">
                ...
                <li class="sidebar-item">
                    <a href="/SuperAdmin/StokBarang" class="sidebar-link <?php echo e(request()->is('SuperAdmin/StokBarang') ? 'active' : ''); ?>">
                        <i class="fa fa-server" style="width:15px;"></i>
                        <span>Data Stok Barang</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="/SuperAdmin/Produk" class="sidebar-link <?php echo e(request()->is('SuperAdmin/Produk') ? 'active' : ''); ?>">
                        <i class="fa fa-database" style="width:15px;"></i>
                        <span>Data Produk</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="/SuperAdmin/Stok" class="sidebar-link <?php echo e(request()->is('SuperAdmin/Stok') ? 'active' : ''); ?>">
                        <i class="fa fa-database" style="width:15px;"></i>
                        <span>Data Stok</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item">
                    <a href="/SuperAdmin/Order" class="sidebar-link <?php echo e(request()->is('SuperAdmin/Order') ? 'active' : ''); ?>">
                        <i class="fas fa-store" style="width:15px;"></i>
                        <span>Order Pelanggan</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="/SuperAdmin/DropPesanan" class="sidebar-link <?php echo e(request()->is('SuperAdmin/DropPesanan') ? 'active' : ''); ?>">
                ...
                <li class="sidebar-item">
                    <a href="/SuperAdmin/Pesanan/Selesai" class="sidebar-link <?php echo e(request()->is('SuperAdmin/Pesanan/Selesai') ? 'active' : ''); ?>">
                ...
                <li class="sidebar-item">
                    <a href="/SuperAdmin/Pengeluaran" class="sidebar-link  <?php echo e(request()->is('SuperAdmin/Pengeluaran') ? 'active' : ''); ?>">
                        <i class="fas fa-sort-amount-down-alt" style="width:15px;"></i>
                        <span>Pengeluaran</span>
                    </a>
                </li>  
                <li class="sidebar-item">
                    <a href="/SuperAdmin/Pemasukan" class="sidebar-link <?php echo e(request()->is('SuperAdmin/Pemasukan') ? 'active' : ''); ?>">
                ...
                <li class="sidebar-item">
                    <a href="/SuperAdmin/Rekapitulasi" class="sidebar-link <?php echo e(request()->is('SuperAdmin/Rekapitulasi') ? 'active' : ''); ?>">
            ...
            <?php elseif($roleuserlogin == "Admin" ): ?>
                <li class="sidebar-item">
                    <a href="/Admin/User" class="sidebar-link <?php echo e(request()->is('Admin/User') ? 'active' : ''); ?>">
                        <i class="fa fa-user" style="width:15px;"></i>
                        <span>Data Pengguna</span>
                    </a>
                </li>  
                <li class="sidebar-item">
                    <a href="/Admin/Kotak" class="sidebar-link <?php echo e(request()->is('Admin/Kotak') ? 'active' : ''); ?>">
                        <i class="fas fa-box" style="width:15px;"></i>
                        <span>Data Kotak</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="/Admin/Pelanggan" class="sidebar-link <?php echo e(request()->is('Admin/Pelanggan') ? 'active' : ''); ?>">
                        <i class="far fa-address-card" style="width:15px;"></i>
                        <span>Data Pelanggan</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="/Admin/StokBarang" class="sidebar-link <?php echo e(request()->is('Admin/StokBarang') ? 'active' : ''); ?>">
                        <i class="fas fa-layer-group" style="width:15px;"></i>
                        <span>Data Stok Barang</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="/Admin/Order" class="sidebar-link <?php echo e(request()->is('Admin/Order') ? 'active' : ''); ?>">
                        <i class="fas fa-shopping-bag" style="width:15px;"></i>
                        <span>Order Pelanggan</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="/Admin/DropPesanan" class="sidebar-link <?php echo e(request()->is('Admin/DropPesanan') ? 'active' : ''); ?>">
                        <i class="fas fa-shopping-bag" style="width:15px;"></i>
                        <span>Drop Pesanan</span>
                    </a>
                </li>
            <?php else: ?>
                <li class="sidebar-item">
                    <a href="/Driver/Pesanan/Dropsit" class="sidebar-link <?php echo e(request()->is('Driver/Pesanan/Dropsit') ? 'active' : ''); ?>">
                        <i class="fas fa-shopping-bag" style="width:15px;"></i>
                        <span>Pesanan Dropsit</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="/PengambilanKotak" class="sidebar-link <?php echo e(request()->is('PengambilanKotak') ? 'active' : ''); ?>">
                        <i class="fas fa-shopping-bag" style="width:15px;"></i>
...
<?php /**PATH D:\PROJECT\LARAVEL\padepokan_store\resources\views/layouts/app.blade.php ENDPATH**/ ?>