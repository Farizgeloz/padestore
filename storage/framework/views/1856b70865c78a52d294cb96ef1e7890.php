...
<div class="card mt-10 mb-5 bg-body-tertiary">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('folder_pelanggan.store')); ?>" method="post" enctype="multipart/form-data" class="row border  border-2 border-success bg-success-subtle rounded p-2">
            <?php echo csrf_field(); ?>
            <div class="col-md-5">
                <div class="row">
...
unset($__errorArgs, $__bag); ?>"  placeholder="Nama Pelanggan"
                            name="nama_pelanggan" value="<?php echo e(old('nama_pelanggan')); ?>" id="">
...
unset($__errorArgs, $__bag); ?>"  placeholder="Telpon"
                            name="telpon" value="<?php echo e(old('telpon')); ?>" id="">
                        <!-- tampilkan pesan error -->
...
unset($__errorArgs, $__bag); ?>"  placeholder="Wilayah"
                            name="wilayah" value="<?php echo e(old('wilayah')); ?>" id="wilayah">
                        <!-- tampilkan pesan error -->
...
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\pabrik_tahu\resources\views/folder_pelanggan/create.blade.php ENDPATH**/ ?>