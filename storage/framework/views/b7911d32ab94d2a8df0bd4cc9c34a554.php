        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered"  style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="textsize9"><?php echo e($produkku->firstItem() + $loop->index); ?></td>
                       
                        <td class=" textsize9"><?php echo e($produk->barcode); ?></td>
                        <td class=" textsize9"><?php echo e($produk->nama_produk); ?></td>
                        <td><?php echo e($produk->sisa_stok); ?></td>
                        <td><?php echo e($produk->harga_rupiah); ?></td>
                         
                        <td style="background-color: <?php echo e($produk->status === 'Habis' ? '#ffb3b3' : 'transparent'); ?>">
                            <?php echo e($produk->status); ?>
                        ...
                        <td class="text-center align-items-center">
                            <!-- dari middleware UserAkses-->
                                ...
                                <?php endif; ?>
                                <button type="button" class="btn btn-primary btn-l" data-bs-toggle="modal" data-bs-target="#exampleModalDetail<?php echo e($produk->id_produk); ?>">
                                   <i class="fa fa-eye"></i>
                                </button>
                                <?php if($roleuserlogin == "Super Admin" ): ?>
                                    <?php if($produk->status !== "Habis"): ?>
                                        <a href="/SuperAdmin/Produk/Edit/<?php echo e($produk->id_produk); ?>"
                                            class="btn btn-l btn-warning"><i class="fa fa-pen"></i></a>
                                        <button type="button" class="btn btn-danger btn-l" data-bs-toggle="modal" data-bs-target="#exampleModalDelete<?php echo e($produk->id_produk); ?>">
                                            <i class="fa fa-trash"></i>
                                        </button>
                                    <?php endif; ?>
                                <?php elseif($roleuserlogin == "Admin" ): ?>
                                    <?php if($produk->status !== "Habis"): ?>
                                        <a href="/Admin/Produk/<?php echo e($produk->id_produk); ?>/Edit"
                                            class="btn btn-l btn-warning">
                                            <i class="fa fa-pen"></i>
                                        </a>
                                        <button type="button" class="btn btn-danger btn-l"
                                            data-bs-toggle="modal"
                                            data-bs-target="#exampleModalDelete<?php echo e($produk->id_produk); ?>">
                                            <i class="fa fa-trash"></i>
                                        </button>
                                    <?php endif; ?>
                                <?php endif; ?>
...
<!------------------------ Modal Detail----------------------------->
                    <div class="modal fade" id="exampleModalDetail<?php echo e($produk->id_produk); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-xl w-100" style="">
                            <div class="p-2 modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Detail (<?php echo e($produk->nama_produk); ?>)</h1>
...
<!------------------------ Modal Delete----------------------------->
                    <div class="modal fade" id="exampleModalDelete<?php echo e($produk->id_produk); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-l">
                            <form action="<?php echo e(route('folder_produk.destroy', $produk->id_produk)); ?>" method="POST" class="p-2 border border-2 rounded border-success">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Data (<?php echo e($produk->nama_produk); ?>)</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
        ...
        <div class="d-flex custom-pagination justify-content-end">
            <?php echo e($produkku->links('pagination::bootstrap-5')); ?>

        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\padepokan_store\resources\views/folder_produk/page_produk.blade.php ENDPATH**/ ?>