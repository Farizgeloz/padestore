            ...
            <table class="table table-striped table-bordered"  style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class=" textsize9"><?php echo e($pemasukan->total_kotak); ?></td>
                        <td class="textsize9">
                            Rp <?php echo e(number_format($pemasukan->total_harga, 0, ',', '.')); ?>

                        </td>
                        <td class=" textsize9"><?php echo e(\Carbon\Carbon::parse($pemasukan->updated_at)->translatedFormat('d F Y')); ?></td>
                        <td style="
...
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\pabrik_tahu\resources\views/folder_pemasukan/page_pemasukan.blade.php ENDPATH**/ ?>