...
<div class="mt-1 mb-5 card bg-body-tertiary">
    ...
    <div class="bg-white card-header">
        <h4><i class="fa fa-database"></i> Daftar Drop Pesanan</h4>
    </div>
...
unset($__sessionArgs); ?>
        ...
        <a href="/Driver/Pesanan/Dropsit/Tambah" class="mb-3 btn btn-success btn-sm"> <i class="fa fa-plus"></i> Update Drop Pesanan</a>
        
       

      
        <form method="GET" action="/Driver/Pesanan/Dropsit/Search" class="mb-2 row">
...
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\pabrik_tahu\resources\views/folder_pesanan_dropsit/page_pesanan_dropsit.blade.php ENDPATH**/ ?>