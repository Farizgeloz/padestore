...
unset($__sessionArgs); ?>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered"  style="width:100%">
                ...
                <tbody>
                    <?php $__currentLoopData = $stokku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="textsize9"><?php echo e($stokku->firstItem() + $loop->index); ?></td>
                       
                        <td class=" textsize9"><?php echo e($stok->nama_produk); ?></td>
                        <td><?php echo e($stok->tipe); ?></td>
                        <td><?php echo e($stok->qty); ?></td>
                        <td><?php echo e($stok->referensi); ?></td>
                        ...
                        <td class="text-center align-items-center">
                            <!-- dari middleware UserAkses-->
                                ...
                                <?php endif; ?>
                                <button type="button" class="btn btn-primary btn-l" data-bs-toggle="modal" data-bs-target="#exampleModalDetail<?php echo e($stok->id_stok); ?>">
                                   <i class="fa fa-eye"></i>
                                </button>
                                <?php if($roleuserlogin == "Super Admin" ): ?>
                                    <?php if($stok->status !== "Habis"): ?>
                                        <a href="/SuperAdmin/Stok/Edit/<?php echo e($stok->id_stok); ?>"
                                            class="btn btn-l btn-warning"><i class="fa fa-pen"></i></a>
                                        <button type="button" class="btn btn-danger btn-l" data-bs-toggle="modal" data-bs-target="#exampleModalDelete<?php echo e($stok->id_stok); ?>">
                                            <i class="fa fa-trash"></i>
                                        </button>
                                    <?php endif; ?>
                                <?php elseif($roleuserlogin == "Admin" ): ?>
                                    <?php if($stok->status !== "Habis"): ?>
                                        <a href="/Admin/Stok/<?php echo e($stok->id_stok); ?>/Edit"
                                            class="btn btn-l btn-warning">
                                            <i class="fa fa-pen"></i>
                                        </a>
                                        <button type="button" class="btn btn-danger btn-l"
                                            data-bs-toggle="modal"
                                            data-bs-target="#exampleModalDelete<?php echo e($stok->id_stok); ?>">
                                            <i class="fa fa-trash"></i>
                                        </button>
                                    <?php endif; ?>
                                <?php endif; ?>
...
<!------------------------ Modal Detail----------------------------->
                    <div class="modal fade" id="exampleModalDetail<?php echo e($stok->id_stok); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-xl w-100" style="">
                            <div class="p-2 modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Detail (<?php echo e($stok->nama_produk); ?>)</h1>
...
<!------------------------ Modal Delete----------------------------->
                    <div class="modal fade" id="exampleModalDelete<?php echo e($stok->id_stok); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-l">
                            <form action="<?php echo e(route('folder_produk.destroy', $stok->id_stok)); ?>" method="POST" class="p-2 border border-2 rounded border-success">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Data (<?php echo e($stok->nama_stok); ?>)</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
        ...
        <div class="d-flex custom-pagination justify-content-end">
            <?php echo e($stokku->links('pagination::bootstrap-5')); ?>

        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\padepokan_store\resources\views/folder_stok/page_stok.blade.php ENDPATH**/ ?>