...
<div class="mt-1 mb-5 card bg-body-tertiary">
    ...
    <div class="bg-white card-header">
        <h4><i class="fa fa-database"></i> Verifikasi Kotak</h4>
    </div>
    ...
    <div class="card-body">
        ...
        <form method="GET" action="/SuperAdmin/VerifikasiKotak/Search" class="mb-2 row">
        <?php elseif($roleuserlogin == "Admin" ): ?>
        <form method="GET" action="/Admin/VerifikasiKotak/Search" class="mb-2 row">
        <?php else: ?>
        <form method="GET" action="/VerifikasiKotak/Search" class="mb-2 row">
        <?php endif; ?>
        ...
        <div class="table-responsive">
            <form action="<?php echo e(route('folder_kotakverifikasi.update_multiple')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\pabrik_tahu\resources\views/folder_kotakverifikasi/page_kotakverifikasi.blade.php ENDPATH**/ ?>