...
<div class="card mt-10 mb-5 bg-body-tertiary">
    ...
    <div class="card-body">
        ...
        <a href="/SuperAdmin/Pesanan/Deliver" class="btn btn-info btn-l mb-2 text-light"><i class="fa fa-arrow-left"></i> Kembali</a>
    
        <?php elseif($roleuserlogin == "Admin" ): ?>
        <a href="/Admin/Pesanan/Deliver" class="btn btn-info btn-l mb-2 text-light"><i class="fa fa-arrow-left"></i> Kembali</a>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <form action="<?php echo e(route('folder_pesanandeliver.store')); ?>" method="post" enctype="multipart/form-data" class="row border  border-2 border-success bg-success-subtle rounded p-2">
            <?php echo csrf_field(); ?>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="form-group mb-2  col-md-12">
                        ...
                        <select class="form-select form-select-lg m-1 <?php $__errorArgs = ['jenis'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="form-group mb-2  col-md-12">
                        <label class="font-weight-bold">Pengantar</label>
                        <select class="form-select form-select-lg m-1 <?php $__errorArgs = ['pengantar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                    ...
                    <div class="form-group mb-2  col-md-12">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <?php $__currentLoopData = $kotakku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kotak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check form-check-inline m-2 align-items-center  border  border-2 <?php echo e($kotak->status === 'Keluar' ? 'border-danger' : 'border-success'); ?> rounded">
                                    <input 
                                    ...
                                    <label 
                                        class="form-check-label  px-1 fw-semibold <?php echo e($kotak->status === 'Keluar' ? 'text-danger' : 'text-dark'); ?>" 
...
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\padepokan_store\resources\views/folder_pesanandeliver/create.blade.php ENDPATH**/ ?>